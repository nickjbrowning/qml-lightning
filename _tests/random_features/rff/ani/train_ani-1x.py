...
from qml_lightning.models.random_features import RandomFourrierFeatures
...
if __name__ == "__main__":
    ...
    model = RandomFourrierFeaturesModel(representation, elements=elements, sigma=sigma, llambda=llambda,
