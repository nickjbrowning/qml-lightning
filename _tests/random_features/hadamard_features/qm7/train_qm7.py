...
if __name__ == "__main__":
    ...
    parser.add_argument("-nreductor_samples", type=int, default=3000)
    ...
    model.get_reductors([new_coords[i] for i in reductor_samples], [new_charges[i]for i in reductor_samples], npcas=npcas, npca_choice=512)
