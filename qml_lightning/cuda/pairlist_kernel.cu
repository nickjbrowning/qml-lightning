...
__global__ void get_num_neighbours_kernel(const torch::PackedTensorAccessor32<float, 3, torch::RestrictPtrTraits> coordinates, float rcut2,
...
__global__ void get_neighbour_list_kernel(const torch::PackedTensorAccessor32<float, 3, torch::RestrictPtrTraits> coordinates, float rcut2,
...
get_num_neighbours_kernel<<<numBlocks, threadsPerBlock, 3 * nthreads * sizeof(float)>>>( coordinates.packed_accessor32<float, 3, torch::RestrictPtrTraits>(),
...
get_neighbour_list_kernel<<<numBlocks, threadsPerBlock, 3 * nthreads * sizeof(float)>>>( coordinates.packed_accessor32<float, 3, torch::RestrictPtrTraits>(),
		rcut2, neighbour_list.packed_accessor32<int, 3, torch::RestrictPtrTraits>());
